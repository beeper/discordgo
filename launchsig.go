...
// A LaunchSignature is a valid version 4 UUID that further encodes the presence
// of certain properties on the JavaScript window object at certain bit positions.
//
// Launch signatures are generated by libdiscore.
type LaunchSignature uuid.UUID

// This incidentally includes the bits that must be zeroed in a valid version 4 UUID.
var vanillaBitmask = [uuidv4ByteSize]byte{0xff, 0x7f, 0xef, 0xef, 0xf7, 0xef, 0x47, 0xff, 0x9f, 0x7e, 0xff, 0xbf, 0xfe, 0xff, 0xf7, 0xff}

// Vanilla randomly generates a valid launch signature corresponding to a completely unmodified
